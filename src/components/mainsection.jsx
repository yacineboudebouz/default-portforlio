...
const MainSection = () => {
    return (
        <div className=" w-full sm:h-screen h-full  flex sm:flex-row flex-col-reverse sm:justify-between pb-8 items-center">
            <dvi className="">
                <motion.h1 variants={textVariant()} className=' text-white font-bold sm:text-[50px] text-[30px] sm:pt-0 pt-24'>Hi i am nigga </motion.h1>
                ...
                <motion.div variants={slideIn('left')} className=' flex   items-center'>
                    ...
                    <p className=' pl-3'>Nigga Rock, Nigeria</p>

                </motion.div>
                <motion.div variants={slideIn('left')} className=' flex  items-center'>
                    <div className='  h-[10px] w-[10px] rounded-full bg-green-700' />
                    <p className=' pl-3'>I am ready for sex</p>
                </motion.div>
